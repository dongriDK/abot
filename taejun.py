...
async def on_message(message):
    ...
    if (message.author.name != "태준이" and message.author.name != "InFi-EYE"):
        if("!ㅌ" not in message.content):
            ...
            if message.channel.id == 926118022245142538 and (message.author.id != 263662225309433857 or message.author.id != 903288998577983530 or message.author.id != 397084939897667584):
                await message.delete()
